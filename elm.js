...
Elm.Gravity.make = function (_elm) {
   "use strict";
   _elm.Gravity = _elm.Gravity || {};
   if (_elm.Gravity.values)
...
Elm.ThreeBodies = Elm.ThreeBodies || {};
Elm.ThreeBodies.make = function (_elm) {
   "use strict";
   _elm.ThreeBodies = _elm.ThreeBodies || {};
   if (_elm.ThreeBodies.values)
   ...
   app.tasks);
   var main = app.html;
   _elm.ThreeBodies.values = {_op: _op
                             ,main: main
                             ,app: app
                             ,init: init
                             ,ticker: ticker
...
Elm.TimeSeries.make = function (_elm) {
   ...
   var toForm = F4(function (dimmensions,
   range,
   lineStyle,
   ts) {
      return A4($Plot.dataToForm,
      lineStyle,
      dimmensions,
      toRange(ts),
      ts.dataPoints);
   ...
   styledTSs) {
      return function () {
         ...
         $Plot.rangeMax,
         $Plot.emptyRange)(A2($List.map,
         function ($) {
            return toRange($Basics.snd($));
         },
         styledTSs));
         var plotForms = $List.map(function (_v0) {
            return function () {
               switch (_v0.ctor)
               {case "_Tuple2":
                  return A4($Plot.dataToForm,
...
Elm.Vector.make = function (_elm) {
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var norm = function (_v0) {
      return function () {
         return $Basics.sqrt(_v0.x * _v0.x + _v0.y * _v0.y);
      }();
   };
   var scale = F2(function (by,
   _v2) {
      return function () {
         return {_: {}
                ,x: by * _v2.x
